...
int gen_instr_valid()
{
    return ((icode) == (I_NOP) || (icode) == (I_HALT) || (icode) == 
      ...
      (icode) == (I_MRMOVL) || (icode) == (I_IADDL) || (icode) == (I_LEAVE)
...
int gen_need_valC()
{
    return ((icode) == (I_IRMOVL) || (icode) == (I_IADDL) || (icode) == 
...
int gen_srcB()
{
    return (((icode) == (I_ALU) || (icode) == (I_RMMOVL) || (icode) == 
        (I_IADDL) || (icode) == (I_MRMOVL)) ? (rb) : ((icode) == (I_PUSHL)
...
int gen_dstE()
{
    return ((((icode) == (I_RRMOVL)) & (cond)) ? (rb) : ((icode) == 
      ...
      ((icode) == (I_PUSHL) || (icode) == (I_POPL) || (icode) == (I_LEAVE)
...
int gen_aluB()
{
    return (((icode) == (I_IADDL) || (icode) == (I_RMMOVL) || (icode) == 
        (I_MRMOVL) || (icode) == (I_ALU) || (icode) == (I_CALL) || (icode)
