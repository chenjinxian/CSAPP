 ...
 * CS:APP Data Lab 
 * 
 * <chenjinxian alanchen1203@gmail.com>
 * 
...
int bang(int x) {
    int val1 = (~x) + 1;
    //if x != 0 then val2 will be 0xffffffff
    int val2 = (val1 | x) >> 31; 
    return val2 + 1;
}
/* 
